    ...
    def build_result(
        ...
        *,
        ...
        return PhotoIngestionResult(
            ...
            error_count=counters.analysis_failed_file_count,
            status=status,
            ...
            inserted_asset_count=counters.inserted_item_count,
            updated_asset_count=counters.updated_item_count,
            unchanged_asset_count=counters.unchanged_item_count,
            skipped_asset_count=counters.skipped_item_count,
            missing_from_source_count=counters.missing_from_source_count,
